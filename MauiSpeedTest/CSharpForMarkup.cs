...
namespace CSharpForMarkup // Guidance at https://github.com/VincentH-Net/CSharpForMarkup; version 20190627.1
{
    public static class XamarinFormsMarkupExtensions
    {
        ...
        { // Key: full type name of view, Value: the default BindableProperty
            { "Microsoft.Maui.Controls.ActivityIndicator", ActivityIndicator.IsRunningProperty },
            { "Microsoft.Maui.Controls.BoxView", BoxView.ColorProperty },
            { "Microsoft.Maui.Controls.Button", Button.CommandProperty },
            { "Microsoft.Maui.Controls.DatePicker", DatePicker.DateProperty },
            { "Microsoft.Maui.Controls.Editor", Editor.TextProperty },
            { "Microsoft.Maui.Controls.Entry", Entry.TextProperty },
            { "Microsoft.Maui.Controls.Image", Image.SourceProperty },
            { "Microsoft.Maui.Controls.Label", Label.TextProperty },
            { "Microsoft.Maui.Controls.ListView", ListView.ItemsSourceProperty },
            { "Microsoft.Maui.Controls.MasterDetailPage", Page.TitleProperty },
            { "Microsoft.Maui.Controls.MultiPage", Page.TitleProperty },
            { "Microsoft.Maui.Controls.NavigationPage", Page.TitleProperty },
            { "Microsoft.Maui.Controls.CarouselPage", Page.TitleProperty },
            { "Microsoft.Maui.Controls.ContentPage", Page.TitleProperty },
            { "Microsoft.Maui.Controls.Page", Page.TitleProperty },
            { "Microsoft.Maui.Controls.TabbedPage", Page.TitleProperty },
            { "Microsoft.Maui.Controls.TemplatedPage", Page.TitleProperty },
            { "Microsoft.Maui.Controls.Picker", Picker.SelectedIndexProperty },
            { "Microsoft.Maui.Controls.ProgressBar", ProgressBar.ProgressProperty },
            { "Microsoft.Maui.Controls.SearchBar", SearchBar.SearchCommandProperty },
            { "Microsoft.Maui.Controls.Slider", Slider.ValueProperty },
            { "Microsoft.Maui.Controls.Stepper", Stepper.ValueProperty },
            { "Microsoft.Maui.Controls.Switch", Switch.IsToggledProperty },
            { "Microsoft.Maui.Controls.TableView", TableView.BindingContextProperty },
            { "Microsoft.Maui.Controls.TimePicker", TimePicker.TimeProperty },
            { "Microsoft.Maui.Controls.WebView", WebView.SourceProperty },
            { "Microsoft.Maui.Controls.TextCell", TextCell.TextProperty },
            { "Microsoft.Maui.Controls.ToolbarItem", ToolbarItem.CommandProperty },
            { "Microsoft.Maui.Controls.TapGestureRecognizer", TapGestureRecognizer.CommandProperty },
            { "Microsoft.Maui.Controls.Span", Span.TextProperty }
        };
        ...
        public static TView DisableAnimations<TView>(this TView list) where TView : ListView
        {
            list.On<iOS>().SetRowAnimationsEnabled(false);
        ...
        public static TView LeftExpand<TView>(this TView view) where TView : View { view.HorizontalOptions = LayoutOptions.Start; return view; }
        public static TView CenterExpandH<TView>(this TView view) where TView : View { view.HorizontalOptions = LayoutOptions.Center; return view; }
        public static TView FillExpandH<TView>(this TView view) where TView : View { view.HorizontalOptions = LayoutOptions.Fill; return view; }
        public static TView RightExpand<TView>(this TView view) where TView : View { view.HorizontalOptions = LayoutOptions.End; return view; }
        ...
        public static TView TopExpand<TView>(this TView view) where TView : View { view.VerticalOptions = LayoutOptions.Start; return view; }
        public static TView BottomExpand<TView>(this TView view) where TView : View { view.VerticalOptions = LayoutOptions.End; return view; }
        public static TView CenterExpandV<TView>(this TView view) where TView : View { view.VerticalOptions = LayoutOptions.Center; return view; }
        public static TView FillExpandV<TView>(this TView view) where TView : View { view.VerticalOptions = LayoutOptions.Fill; return view; }
        ...
        #region Joe's Additions
        public static TElement BackgroundColor<TElement>(this TElement element, Color color) where TElement : VisualElement { element.BackgroundColor = color; return element; }

        public static TButton ButtonText<TButton>(this TButton button, string text) where TButton : Button { button.Text = text; return button; }
        public static TButton ButtonTextColor<TButton>(this TButton button, Color color) where TButton : Button { button.TextColor = color; return button; }
        public static TButton ButtonCommand<TButton>(this TButton button, ICommand command) where TButton : Button { button.Command = command; return button; }
        public static TButton ButtonFontFamily<TButton>(this TButton button, string fontFamily) where TButton : Button { button.FontFamily = fontFamily; return button; }
        public static TButton ButtonFontSize<TButton>(this TButton button, double fontSize) where TButton : Button { button.FontSize = fontSize; return button; }

        public static TLabel LabelText<TLabel>(this TLabel label, string text) where TLabel : Label { label.Text = text; return label; }
        public static TLabel LabelTextColor<TLabel>(this TLabel label, Color color) where TLabel : Label { label.TextColor = color; return label; }
        public static TLabel LabelFontFamily<TLabel>(this TLabel label, string fontFamily) where TLabel : Label { label.FontFamily = fontFamily; return label; }
        public static TLabel LabelFontSize<TLabel>(this TLabel label, double fontSize) where TLabel : Label { label.FontSize = fontSize; return label; }
        #endregion
        ...
        {
            cell.On<iOS>().SetDefaultBackgroundColor(color);
            return cell;
        }
